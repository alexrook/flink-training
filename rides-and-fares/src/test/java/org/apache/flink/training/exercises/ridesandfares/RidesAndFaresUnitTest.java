...
public class RidesAndFaresUnitTest extends RidesAndFaresTestBase {
	...
	private final RichCoFlatMapFunction<TaxiRide, TaxiFare, RideAndFare> javaExercise = new RidesAndFaresExercise.EnrichmentFunction();

	protected ComposedRichCoFlatMapFunction<TaxiRide, TaxiFare, RideAndFare> composedEnrichmentFunction() {
		return new ComposedRichCoFlatMapFunction<>(javaExercise, javaExercise);
	}
	...
	public void testRideStateCreatedAndCleared() throws Exception {
		...
		// Verify the result
		StreamRecord<RideAndFare> expected = new StreamRecord<>(new RideAndFare(ride1, fare1),
	...
	private KeyedTwoInputStreamOperatorTestHarness<Long, TaxiRide, TaxiFare, RideAndFare> setupHarness(
		...
		KeyedTwoInputStreamOperatorTestHarness<Long, TaxiRide, TaxiFare, RideAndFare> testHarness = new KeyedTwoInputStreamOperatorTestHarness<>(
