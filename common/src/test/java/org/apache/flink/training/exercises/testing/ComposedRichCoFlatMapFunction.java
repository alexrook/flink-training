 ...
 * either the exercise or in the solution. The implementation in the exercise is
 * tested first, and if it throws MissingSolutionException, then the solution is
 * tested instead.
 *
 * <p>
 ...
 */
public class ComposedRichCoFlatMapFunction<IN1, IN2, OUT> extends RichCoFlatMapFunction<IN1, IN2, OUT> {
	...
	public ComposedRichCoFlatMapFunction(RichCoFlatMapFunction<IN1, IN2, OUT> exercise,
