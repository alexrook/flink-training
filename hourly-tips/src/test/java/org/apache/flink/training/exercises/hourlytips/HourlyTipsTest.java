...
public class HourlyTipsTest {
	...
	public void testMaxAcrossDrivers() throws Exception {
		...
		ParallelTestSource<TaxiFare> source = new ParallelTestSource<>(oneFor1In1, fiveFor1In1, tenFor1In2,
				twentyFor2In2, zeroFor3In2, zeroFor4In2, oneFor4In2, tenFor5In2);
	...
	private ComposedPipeline<TaxiFare, Tuple3<Long, Long, Float>> hourlyTipsPipeline() {
		...
		ExecutablePipeline<TaxiFare, Tuple3<Long, Long, Float>> exercise = (source,
				sink) -> new HourlyTipsExercise(source, sink).execute();
